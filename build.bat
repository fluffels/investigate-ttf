...
clang.exe -g -ferror-limit=1 -DWIN32 -std=gnu++20 -I .\\lib\\jcwk -I %VULKAN_SDK%\\Include -I .\\lib src/MainWin32.cpp ^
          -l %VULKAN_SDK%\\Lib\\vulkan-1.lib -nostdlib -lmsvcrt -target x86_64-pc-win32 ^
          -luser32.lib build/spirv_reflect.o -o build/main.exe && ^
.\\build\\main.exe
